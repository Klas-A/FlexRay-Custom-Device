	...
	<Item Name="System Explorer" Type="Folder">
		<Item Name="Dynamically Called" Type="Folder">
			<Item Name="Extra Pages" Type="Folder">
				<Item Name="Cyclic.vi" Type="VI" URL="../Cyclic.vi"/>
				<Item Name="Enable_Disable.vi" Type="VI" URL="../Enable_Disable.vi"/>
				...
				<Item Name="POC State.vi" Type="VI" URL="../POC State.vi"/>
				<Item Name="Signal.vi" Type="VI" URL="../Signal.vi"/>
			</Item>
			<Item Name="RTM" Type="Folder">
				<Item Name="Add Frames.vi" Type="VI" URL="../SubVIs/Add Frames.vi"/>
				<Item Name="Delete Multiple Frames.vi" Type="VI" URL="../SubVIs/Delete Multiple Frames.vi"/>
			</Item>
			<Item Name="Initialization VI.vi" Type="VI" URL="../Initialization VI.vi"/>
			<Item Name="Main Page.vi" Type="VI" URL="../Main Page.vi"/>
		</Item>
		<Item Name="SubVIs" Type="Folder">
			<Item Name="Configure (Port and DB).vi" Type="VI" URL="../SubVIs/Configure (Port and DB).vi"/>
			<Item Name="UpdateFrameList.vi" Type="VI" URL="../SubVIs/UpdateFrameList.vi"/>
		</Item>
	</Item>
</Library>
