...
<Library LVVersion="20008000">
	...
	<Item Name="Shared" Type="Folder">
		<Item Name="Types" Type="Folder">
			<Item Name="AddFramesState.ctl" Type="VI" URL="../AddFramesState.ctl"/>
			<Item Name="FRConfig.ctl" Type="VI" URL="../FRConfig.ctl"/>
			<Item Name="FRFrameType.ctl" Type="VI" URL="../FRFrameType.ctl"/>
			<Item Name="FRInterface.ctl" Type="VI" URL="../FRInterface.ctl"/>
		</Item>
		<Item Name="Constants.vi" Type="VI" URL="../Constants.vi"/>
		<Item Name="FREventInfo.ctl" Type="VI" URL="../FREventInfo.ctl"/>
	</Item>
</Library>
